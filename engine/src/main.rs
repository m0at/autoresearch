use anyhow::Result;
use autoresearch_engine::config::SEQ;
use autoresearch_engine::optim::{Schedule, ScheduleConfig};
use autoresearch_engine::train::{train, TrainConfig};
